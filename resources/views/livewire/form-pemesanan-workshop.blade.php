        ...
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-lg overflow-hidden animate-fade-in-up">
            ...
            <div class="p-6 space-y-4 text-gray-700">
                ...
                <div class="bg-gray-50 p-4 rounded-lg space-y-2 border border-gray-100">
                    ...
                    <div class="flex justify-between">
                        <span class="font-semibold">Nama Grup:</span>
                        <span>{{ $nama_grup }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="font-semibold">Jadwal Mulai:</span>
                        <span>{{ $jadwal_workshop->waktu_mulai }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="font-semibold">Jadwal Selesai:</span>
                        <span>{{ $jadwal_workshop->waktu_selesai }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="font-semibold">Jumlah:</span>
                        <span>{{ $jumlah_anggota }} anggota</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="font-semibold">Harga Per Anggota:</span>
                        <span>Rp {{ number_format($catalog->harga, 0, ',', '.') }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="font-semibold">Total Harga:</span>
                        <span>Rp {{ number_format(($catalog->harga * $jumlah_anggota), 0, ',', '.') }}</span>
                    </div>
